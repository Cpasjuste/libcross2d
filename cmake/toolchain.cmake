...
elseif (PLATFORM_PS4)
    if (DEFINED ENV{ORBISDEV})
        set(TARGET_PLATFORM ps4 CACHE STRING "target platform" FORCE)
        set(ORBISDEV $ENV{ORBISDEV} CACHE STRING "ORBISDEV" FORCE)
        if (NOT DEFINED CMAKE_TOOLCHAIN_FILE)
            set(CMAKE_TOOLCHAIN_FILE "${ORBISDEV}/cmake/ps4.cmake" CACHE PATH "toolchain file")
        endif ()
    else ()
        message(FATAL_ERROR "Please define ORBISDEV to point to your SDK path!")
    endif ()
elseif (PLATFORM_PS3)
