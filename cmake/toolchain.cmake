...
elseif (PLATFORM_SWITCH)
    if (NOT DEFINED CMAKE_TOOLCHAIN_FILE)
        if (DEFINED ENV{DEVKITPRO})
            set(TARGET_PLATFORM switch CACHE STRING "" FORCE)
            ...
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIE" CACHE STRING "C flags" FORCE)
            set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -fpermissive" CACHE STRING "C++ flags" FORCE)
        else ()
