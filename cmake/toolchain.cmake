...
elseif (PLATFORM_3DS)
    if (DEFINED ENV{DEVKITPRO})
        ...
        if (NOT DEFINED CMAKE_TOOLCHAIN_FILE)
            ...
            set(CMAKE_EXE_LINKER_FLAGS "-L${DEVKITPRO}/libctru/lib -L${DEVKITPRO}/portlibs/3ds/lib -specs=${DEVKITPRO}/devkitARM/arm-none-eabi/lib/3dsx.specs" CACHE STRING "" FORCE)
        endif ()
    else ()
        message(FATAL_ERROR "Please define DEVKITPRO to point to your SDK path!")
    endif ()
