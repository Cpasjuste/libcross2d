...
#define glPushMatrix tglPushMatrix
#define glLoadIdentity tglLoadIdentity
#define glMultMatrixf tglMultMatrixf
#define glLoadMatrixf tglLoadMatrixf
#define glEnable tglEnable
#define glBindTexture tglBindTexture
#define glBegin tglBegin
#define glTexCoord2f tglTexCoord2f
#define glColor4f tglColor4f
#define glVertex2f tglVertex2f
#define glVertex3f tglVertex3f
#define glEnd tglEnd
#define glDisable tglDisable
#define glPopMatrix tglPopMatrix
#define glBlendFunc tglBlendFunc
#define glMatrixMode tglMatrixMode
#define glOrtho tglOrtho
#define glClearColor tglClearColor
#define glClear tglClear
#define glViewport tglViewport

#define GLenum TGLenum
#define GL_POINTS TGL_POINTS
#define GL_LINES TGL_LINES
#define GL_LINE_STRIP TGL_LINE_STRIP
#define GL_TRIANGLES TGL_TRIANGLES
#define GL_TRIANGLE_STRIP TGL_TRIANGLE_STRIP
#define GL_TRIANGLE_FAN TGL_TRIANGLE_FAN
#define GL_QUADS TGL_QUADS
#define GL_CULL_FACE TGL_CULL_FACE
#define GL_DEPTH_TEST TGL_DEPTH_TEST
#define GL_ALPHA_TEST TGL_ALPHA_TEST
#define GL_BLEND TGL_BLEND
#define GL_SRC_ALPHA TGL_SRC_ALPHA
#define GL_ONE_MINUS_SRC_ALPHA TGL_ONE_MINUS_SRC_ALPHA
#define GL_PROJECTION TGL_PROJECTION
#define GL_MODELVIEW TGL_MODELVIEW
#define GL_COLOR_BUFFER_BIT TGL_COLOR_BUFFER_BIT
#define GL_DEPTH_BUFFER_BIT TGL_DEPTH_BUFFER_BIT
#define GL_TEXTURE_2D TGL_TEXTURE_2D
#define GL_LIGHTING TGL_LIGHTING
#define GL_FALSE TGL_FALSE

#define glGenTextures tglGenTextures
#define glBindTexture tglBindTexture
#define glTexImage2D tglTexImage2D
#define glTexSubImage2D glTexImage2D
#define glTexParameteri tglTexParameteri
#define GL_RGBA TGL_RGBA
#define GL_UNSIGNED_BYTE TGL_UNSIGNED_BYTE
#define GL_TEXTURE_MIN_FILTER TGL_TEXTURE_MIN_FILTER
#define GL_NEAREST TGL_NEAREST
#define GL_TEXTURE_MAG_FILTER TGL_TEXTURE_MAG_FILTER
#define GLsizei TGLsizei
#define GL_RGB TGL_RGB
#define GL_UNSIGNED_SHORT_5_6_5 TGL_UNSIGNED_BYTE
#define glDeleteTextures tglDeleteTextures
#define glDepthMask tglDepthMask
#endif
