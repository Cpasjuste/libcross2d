...
enum surfaces {
    REALITY_SURFACE_COLOR0, REALITY_SURFACE_COLOR1, REALITY_SURFACE_COLOR2,
    REALITY_SURFACE_COLOR3, REALITY_SURFACE_ZETA
};

void internal_reality_SetRenderSurface(gcmContextData *context, uint8_t sufrace, uint8_t location, uint32_t offset,
                                       uint32_t pitch);
...
void
internal_reality_BindVertexBufferAttribute(gcmContextData *context, uint8_t attribute, uint32_t offset, uint8_t stride,
                                           uint8_t elements, uint8_t dataType, uint8_t location);
...
void internal_reality_DrawVertexBufferIndex(gcmContextData *context, uint32_t type, uint32_t offset, uint32_t count,
                                            uint8_t dataType, uint8_t location);
...
void internal_reality_SetVertexProgramConstant4fBlock(gcmContextData *context, int constant, int num4fConstants,
                                                      float *values);

void internal_reality_InstallFragmentProgram(gcmContextData *context, internal_reality_FragmentProgram *prog,
                                             uint32_t *addr);
...
void
internal_reality_ZControl(gcmContextData *context, uint8_t cullNearFar, uint8_t zClampEnable, uint8_t cullIngnoreW);
