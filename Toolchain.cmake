...
if (BUILD_PSP2)
    ...
    set(CROSS2D_FLAGS "-D__HANDLED_CABMODE__" CACHE STRING "CROSS2D flags")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${CROSS2D_FLAGS}" CACHE STRING "C flags")
    set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} ${CMAKE_CXX_FLAGS}" CACHE STRING "C++ flags")
...
if (BUILD_NX)
    ...
    set(CROSS2D_FLAGS "-D__HANDLED_CABMODE__" CACHE STRING "CROSS2D flags")
    set(CMAKE_C_FLAGS "${CROSS2D_FLAGS} -march=armv8-a -mtune=cortex-a57 -mtp=soft -fPIE -ffast-math -ffunction-sections -fdata-sections -I${DEVKITPRO}/libnx/include -I${DEVKITPRO}/portlibs/armv8-a/include -I${DEVKITPRO}/portlibs/switch/include" CACHE STRING "C flags")
    set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -fpermissive -fno-rtti -fno-exceptions -std=gnu++11" CACHE STRING "C++ flags")
    set(CMAKE_FIND_ROOT_PATH ${DEVKITPRO} ${DEVKITPRO}/devkitA64 ${DEVKITPRO}/libnx ${DEVKITPRO}/portlibs/armv8-a ${DEVKITPRO}/portlibs/switch)
    set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
    set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
    set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
    set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
