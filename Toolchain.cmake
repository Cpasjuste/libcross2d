...
if (PLATFORM_RPI3)
    set(CMAKE_SYSTEM_NAME "Linux")
    set(PLATFORM_LINUX ON CACHE BOOL "")
    if (OPTION_RECALBOX)
        ...
        if (${X64})
            ...
            set(RPI3_SDK /opt/recalbox/recalbox-rpi3/output/host)
            set(RPI3_SYS ${RPI3_SDK}/arm-buildroot-linux-gnueabihf/sysroot)
            set(TARGET_PLATFORM rpi3 CACHE STRING "" FORCE)
        endif ()
        set(CMAKE_C_COMPILER "${RPI3_SDK}/bin/${CMAKE_SYSTEM_PROCESSOR}-linux-gcc")
        set(CMAKE_CXX_COMPILER "${RPI3_SDK}/bin/${CMAKE_SYSTEM_PROCESSOR}-linux-g++")
        set(CMAKE_ASM_COMPILER "${RPI3_SDK}/bin/${CMAKE_SYSTEM_PROCESSOR}-linux-as")
        set(CMAKE_AR "${RPI3_SDK}/bin/${CMAKE_SYSTEM_PROCESSOR}-linux-ar")
        set(CMAKE_RANLIB "${RPI3_SDK}/bin/${CMAKE_SYSTEM_PROCESSOR}-linux-ranlib")
