...
if (BUILD_NX)
    ...
    set(CROSS2D_FLAGS "-D__HANDLED_CABMODE__" CACHE STRING "CROSS2D flags")
    set(CMAKE_C_FLAGS "${CROSS2D_FLAGS} -march=armv8-a -mtune=cortex-a57 -mtp=soft -fPIE -ffast-math -ffunction-sections -fdata-sections -I${DEVKITPRO}/libnx/include -I${DEVKITPRO}/portlibs/armv8-a/include" CACHE STRING "C flags")
