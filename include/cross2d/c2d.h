...
#define KEY_JOY_FIRE3_DEFAULT   3
#define KEY_JOY_FIRE4_DEFAULT   0
#define KEY_JOY_FIRE5_DEFAULT   10
#define KEY_JOY_FIRE6_DEFAULT   11
#define KEY_JOY_COIN1_DEFAULT   4
#define KEY_JOY_START1_DEFAULT  5
#define KEY_JOY_MENU1_DEFAULT   5
