...
add_custom_target(${PROJECT_NAME}.data
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_SOURCE_DIR}/data/ro ${CMAKE_CURRENT_BINARY_DIR}/data_ro
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_SOURCE_DIR}/data/rw ${CMAKE_CURRENT_BINARY_DIR}/data_rw
        )
...
if (BUILD_LINUX OR BUILD_WINDOWS)
    ...
    add_custom_target(${PROJECT_NAME}_${TARGET_PLATFORM}_release.zip
            ...
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_BINARY_DIR}/data_ro ${CMAKE_BINARY_DIR}/release/${PROJECT_NAME}/data
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_BINARY_DIR}/data_rw ${CMAKE_BINARY_DIR}/release/${PROJECT_NAME}/data
...
###########################
if (BUILD_SWITCH)
    #set_target_properties(${PROJECT_NAME} PROPERTIES LINK_FLAGS "-specs=${DEVKITPRO}/libnx/switch.specs")
    add_custom_target(${PROJECT_NAME}.nro
            ...
            COMMAND ${DEVKITPRO}/tools/bin/elf2nro ${PROJECT_NAME} ${PROJECT_NAME}.nro --icon=${CMAKE_CURRENT_SOURCE_DIR}/data/switch/icon.jpg --nacp=${PROJECT_NAME}.nacp --romfsdir=${CMAKE_CURRENT_BINARY_DIR}/data_ro)
